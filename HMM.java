  ...
  public HMM(int numberOfStates, int numberOfEmissions) {
    ...
    for (int i = 0; i < numberOfStates; ++i) {
      for (int j = 0; j < numberOfStates; ++j) {      
        this.A[i][j] = 1/numberOfStates + Math.random()*0.5/numberOfStates;
      }
    }
    
    for (int i = 0; i < numberOfStates; ++i) {
      for (int j = 0; j < numberOfEmissions; ++j) {
        this.B[i][j] = 1/numberOfStates + Math.random()*0.5/numberOfStates;
      }
    }
    
    for (int i = 0; i < numberOfStates; ++i) {
      this.pi[i] = 1/numberOfStates + Math.random()*0.5/numberOfStates;
    }
